...
# [Monochrome](https://monochrome.origuchi.uk/)

[Zola](https://www.getzola.org) theme made specifically for personal websites and blogs. No JavaScript but configurable.

![Screenshot](screenshot.png)

## Docs

Docs are provided in a form of [live demo](https://monochrome.origuchi.uk/).
...
_</> with <3 by [origuchi](https://github.com/Tobiichi-Origuchi) | README based on [daudix's](https://codeberg.org/daudix/ametrine)_
